...
echo ""
echo "2. Run the worker (processes chat workflows via Temporal):"
echo "   go run ./worker/cmd/worker/"
echo ""
echo "3. Run the API server (in a separate terminal):"
echo "   go run ./api/main.go"
echo ""
echo "4. Run the web dev server (in a separate terminal):"
echo "   cd web"
echo "   bun install"
echo "   bun dev"
echo ""
